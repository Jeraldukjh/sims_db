...
<body>
    ...
    <div class="mb-3">
        ...
        <input type="text" class="form-control" name="middle_name" placeholder="Enter your middle name (optional)">
    </div>
    <div class="mb-3">
        <label class="form-label">Last Name</label>
        <input type="text" class="form-control" name="name" placeholder="Enter your last name" required>
    </div>
    <div class="mb-3">
